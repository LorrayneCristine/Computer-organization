...
public class GeradorInstrucoes {
	...
	int TAM_FOR = 10; // Tamanho do For i1, i2, i3 ..i10
	int TAM_MEM = 10000; // Tamanho da Memoria (Quantidade de Endereços
									// Possiveis)
	int PROB_FOR = 40; // Probabilidade de Ocorrencia do For (%)
