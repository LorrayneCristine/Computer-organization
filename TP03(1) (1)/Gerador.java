...
public class Gerador {
	...
	static int QTD_INS = 100; // Quantidade de instruções geradas
	static int TAM_FOR = 10; // Tamanho do For
	static int TAM_MEM = 1000000; // Tamanho da Memoria (Quantidade de Endereços
									// Possiveis)
	...
	public static void main(String args[]) throws IOException {
		...
		OutputStream os = new FileOutputStream("instruções.txt");
