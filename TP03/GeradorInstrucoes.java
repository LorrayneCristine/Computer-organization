...
public class GeradorInstrucoes {
	...
	int QTD_INS = 10000; // Quantidade de instru��es geradas
	int TAM_FOR = 70; // Tamanho do For i1, i2, i3 ..i10
	int TAM_MEM = 10000; // Tamanho da Memoria (Quantidade de Endere�os
									// Possiveis)
	int PROB_FOR = 10; // Probabilidade de Ocorrencia do For (%)
